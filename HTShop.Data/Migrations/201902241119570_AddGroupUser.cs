namespace HTShop.Data.Migrations
{
    ...
    public partial class AddGroupUser : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ApplicationRoleGroup", "GroupId", "dbo.ApplicationGroups");
            DropForeignKey("dbo.ApplicationRoleGroup", "RoleId", "dbo.ApplicationRoles");
            DropIndex("dbo.ApplicationUserGroups", new[] { "GroupId" });
            DropIndex("dbo.ApplicationUserGroups", new[] { "UserId" });
            DropIndex("dbo.ApplicationRoleGroup", new[] { "RoleId" });
            DropIndex("dbo.ApplicationRoleGroup", new[] { "GroupId" });
            DropColumn("dbo.ApplicationRoles", "Discriminator");
            DropColumn("dbo.ApplicationRoles", "Description");
            DropTable("dbo.ApplicationUserGroups");
            DropTable("dbo.ApplicationRoleGroup");
